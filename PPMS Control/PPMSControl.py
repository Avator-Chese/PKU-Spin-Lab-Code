...
ip_address='127.0.0.1' #The MultiVu computer's adress. Can be found with commands "ipconfig" at terminal.
remote_control=True #If or not open the remote control
...
class PPMS():
    ...
    def __init__(self):
        self.qdi_instrument = QDInstrumentFactory.GetQDInstrument(QDI_PPMS_TYPE,remote_control, ip_address, DEFAULT_PORT)
